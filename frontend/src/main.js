...
pluralCaseList.push( {plural: "losts/lostServices", pascal: "LostLostService"} )

pluralCaseList.push( {plural: "rents/rentServices", pascal: "RentRentService"} )

pluralCaseList.push( {plural: "customerphones/customerPhones", pascal: "CustomerphoneCustomerPhone"} )

pluralCaseList.push( {plural: "customers/customers", pascal: "CustomerCustomer"} )

pluralCaseList.push( {plural: "rentphones/rentPhones", pascal: "RentphoneRentPhone"} )
